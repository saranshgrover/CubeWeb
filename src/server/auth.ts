import { WCA_OAUTH_CLIENT_ID, WCA_ORIGIN } from './wca-env'
import history from './history'

const localStorageKey = (key: string): string =>
    `WCA-CubeWeb.${WCA_OAUTH_CLIENT_ID}.${key}`
...
export const initializeAuth = () => {
    ...
    if (hashParams.has('expires_in')) {
        ...
        const expiresIn = parseInt(hashParams.get('expires_in') || '15')
